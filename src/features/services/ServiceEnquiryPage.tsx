...
import { buildMarketingContactRows } from '../../config/env';
import { useToast } from '../../contexts/ToastContext';
import './ServiceEnquiryPage.css';

const CONTACT_ITEMS = buildMarketingContactRows();
        ...
        <Container>
          ...
          <header className="service-enquiry-page__header text-center mb-4 mb-md-5">
            ...
            <p className="service-enquiry-page__lead service-enquiry-page__lead--compact text-muted mx-auto mb-0 small">
              ...
              <Link href="/#contacts">homepage contact</Link> instead. Use this form when you want a{' '}
          ...
          <Alert variant="light" className="service-enquiry-page__note mt-4 mb-0 border">
            ...
            <Link href="/#contacts">Homepage contact</Link> is best for general questions or quick gym-product enquiries.
