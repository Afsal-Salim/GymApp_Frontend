...
import PrivacyPolicyArticle from '../../legal/PrivacyPolicyArticle/PrivacyPolicyArticle';
import UserContentPolicyArticle from '../../legal/UserContentPolicyArticle/UserContentPolicyArticle';
...
export default function SignupPage() {
  ...
  }, [googleReady, router, showToast, googleSignupPoliciesReady]);
          ...
          <Col lg={6} className="auth-page__form-col">
            <div className="auth-page__form-inner">
              ...
              <p className="auth-page__switch text-center mt-4 mb-0">
                ...
                <Link href="/login" className="auth-page__link">Log in</Link>
              </p>
            </div>
          </Col>
