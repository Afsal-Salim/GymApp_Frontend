...
import UserContentPolicyArticle from '../UserContentPolicyArticle/UserContentPolicyArticle';
    ...
    <PageContainer className="user-content-policy-page">
      <main className="py-4 pb-5">
        <div className="user-content-policy-page__inner">
          ...
          <h1 className="h3 fw-bold mb-4">User Content Responsibility</h1>
          <div className="lh-lg">
          ...
          <p className="user-content-policy-page__footer small text-muted mt-4 mb-0">
            See also{' '}
            <Link href="/legal/privacy">Privacy Policy</Link>. Questions? Contact support through your account or the
