...
import { GYM_CLIENT_BRAND_LOGO_SRC } from '../gymClientBrandLogo/gymClientBrandLogo';
import { DESIGN_SYSTEM_SETS } from '../../website/websiteBuilderDesignSystemBlocks/websiteBuilderDesignSystemBlocks';
...
const DEFAULT_HERO_BG: string =
  typeof clientDefaultHeroBackground === 'string' ?
    clientDefaultHeroBackground
  : clientDefaultHeroBackground.src;
