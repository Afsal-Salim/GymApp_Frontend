...
a.component-btn[data-wb-open='visit'] {
  background: linear-gradient(135deg, #0f766e 0%, var(--wb-visit-from) 38%, var(--wb-visit-to) 100%);
...
a.component-btn[data-wb-open='trial'] {
  background: linear-gradient(135deg, var(--wb-trial-from) 0%, #ea580c 45%, var(--wb-trial-to) 100%);
...
a.component-btn[data-wb-open='enquiry'] {
  background: linear-gradient(135deg, var(--wb-enquiry-from) 0%, #7c3aed 48%, var(--wb-enquiry-to) 100%);
  border-color: rgba(255, 255, 255, 0.14);
...
a.component-btn[href^='tel:'] {
  color: #fff;
  background: linear-gradient(135deg, #c2410c 0%, var(--wb-phone-from) 40%, var(--wb-phone-to) 100%);
  border-color: rgba(255, 255, 255, 0.14);
...
a.component-btn[href^='mailto:'] {
  color: #fff;
  background: linear-gradient(135deg, #3730a3 0%, var(--wb-mail-from) 42%, var(--wb-mail-to) 100%);
  border-color: rgba(255, 255, 255, 0.14);
...
button.component-btn.wb-wa-btn {
  color: #ecfdf5;
  background: linear-gradient(135deg, #047857 0%, var(--wb-wa-from) 35%, var(--wb-wa-mid) 72%, var(--wb-wa-to) 100%);
