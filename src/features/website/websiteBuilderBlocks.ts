...
function waMeHrefFromDigits(raw: string): string {
  ...
  bm.add('wb-form-contact', {
    ...
    content: `
      <div class="wb-add-el component-card">
        ...
        <div class="component-desc">Editorial layout with refined fields—Send opens your live enquiry modal for a consistent backend.</div>
        <form>
          <input type="text" name="name" placeholder="Full name" autocomplete="name" />
          <input type="tel" name="phone" placeholder="Mobile number" autocomplete="tel" />
