...
import type { ComponentCatalogEntry, ComponentLibraryPreviewKind } from '@/features/website/editor/core/websiteBuilderComponentCatalog/websiteBuilderComponentCatalog';
import { DS_ICO } from '@/features/website/editor/blocks/websiteBuilderDesignSystemIcons/websiteBuilderDesignSystemIcons';
...
/** Optional strip next to nav brand; kept empty so library previews stay clean (no tier pills). */
