 ...
 * flat greys (#efefef) with white text. This tail repeats the library gradients with `!important`
 * so paint wins over composer `#id` rules (unless the user adds their own `!important` on the same
 * property). Keep in sync with `WEBSITE_BUILDER_COMPONENT_LIBRARY_CSS` `.component-btn` rules.
 */
/** Skip coercion when the block author set `background` inline (still beats Grapes #id without !important). */
const WB_NO_INLINE_BG = ':not([style*="background"]):not([style*="Background"])';

const WB_CANVAS_COMPONENT_BTN_COERCION = `
button.component-btn${WB_NO_INLINE_BG},
a.component-btn${WB_NO_INLINE_BG} {
  color: #fff !important;
...
button.component-btn[data-wb-open='visit']${WB_NO_INLINE_BG},
a.component-btn[data-wb-open='visit']${WB_NO_INLINE_BG} {
...
button.component-btn[data-wb-open='trial']${WB_NO_INLINE_BG},
a.component-btn[data-wb-open='trial']${WB_NO_INLINE_BG} {
...
button.component-btn[data-wb-open='enquiry']${WB_NO_INLINE_BG},
a.component-btn[data-wb-open='enquiry']${WB_NO_INLINE_BG} {
...
a.component-btn[href^='tel:']${WB_NO_INLINE_BG} {
  color: #fff !important;
...
a.component-btn[href^='mailto:']${WB_NO_INLINE_BG} {
  color: #fff !important;
...
a.component-btn.wb-wa-btn${WB_NO_INLINE_BG},
button.component-btn.wb-wa-btn${WB_NO_INLINE_BG} {
...
.wb-enquiry-slide .component-btn.wb-enquiry-slide__toggle${WB_NO_INLINE_BG} {
  color: #fff !important;
  background: linear-gradient(135deg, #6d28d9 0%, #7c3aed 48%, #a855f7 100%) !important;
  border-color: rgba(255, 255, 255, 0.14) !important;
  box-shadow: 0 4px 18px rgba(124, 58, 237, 0.38), 0 1px 0 rgba(255, 255, 255, 0.2) inset !important;
...
a.component-btn[download]:not(.wb-wa-btn)${WB_NO_INLINE_BG} {
